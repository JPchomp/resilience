function [objval, flowsol, dualsol, solsummary ,status, MVi, MPCi, MFTCDi] =  solveoptim(from,to,distance,capacity,T,s,t, capmatrix, FTCD , MFTCD , breadth ,MV,MPC,verbose,INDICATOR)
