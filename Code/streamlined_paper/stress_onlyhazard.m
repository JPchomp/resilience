...
Data1 = plot(linspace(0,max(Hv),k),plottingtable(:,1));
Data2 = plot(linspace(0,max(Hv),k),plottingtable(:,2));
...
hTitle  = title ('');
hXLabel = xlabel('Hazard Intensity'                     );
...
Data1 = plot(linspace(0,max(Hv),k),plottingtable(:,3));
Data2 = plot(linspace(0,max(Hv),k),plottingtable(:,4));
