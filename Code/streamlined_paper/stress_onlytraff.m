...
Data1 = plot(linspace(0,max(Tv),k),plottingtable(:,1));
Data2 = plot(linspace(0,max(Tv),k),plottingtable(:,2));
...
hTitle  = title ('');
hXLabel = xlabel('Demand Intensity'                     );
...
Data1 = plot(linspace(0,max(Tv),k),plottingtable(:,3));
Data2 = plot(linspace(0,max(Tv),k),plottingtable(:,4));
